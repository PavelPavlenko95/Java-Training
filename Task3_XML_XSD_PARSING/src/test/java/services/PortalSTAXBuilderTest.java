...
public class PortalSTAXBuilderTest {
    ...
    public void testSAXParser(String a, String b) throws XMLFileException, FileNotFoundException, WrongFileException, XMLStreamException {
        ...
        AbstractPortalParser lectureBuilder = portalParserFactory.parseXML("STAX");
    ...
    public String executeRequest(String req, Lecture lecture) {
        ...
        switch (req) {
            ...
            case "tests" : return lecture.getDate();
